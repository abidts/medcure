...
let isRequestCall: boolean = false;
 ...
 */
async function initializeCall(config: CallConfig): Promise<void> {
 ...
 */
function connectToSignalingServer(roomId: number, username: string, isRequest: boolean): Promise<void> {
    return new Promise((resolve, reject) => {
        try {
            ...
            stompClient.connect({}, () => {
                ...
                stompClient?.subscribe(topic, (message: StompMessage) => {
 ...
 */
function onSignalingMessage(message: StompMessage, roomId: number, username: string, isRequest: boolean): void {
...
function handleJoinAck(signal: any): void {
...
async function handlePeerJoined(signal: any): Promise<void> {
...
async function handleOffer(signal: any): Promise<void> {
    try {
...
async function handleAnswer(signal: any): Promise<void> {
    try {
...
function handleError(signal: any): void {
...
function sendSignal(message: any): void {
...
function updateRemoteStatus(text: string, state: string): void {
