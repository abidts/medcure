...
import com.tabib24x7.model.DoctorAvailability;
import com.tabib24x7.model.DoctorEducation;
import com.tabib24x7.model.DoctorStatus;
import com.tabib24x7.repository.AppointmentRepository;
...
import com.tabib24x7.service.DoctorStatusService;
...
public class DoctorDashboardController {
    ...
    @Autowired
    private com.tabib24x7.service.MedicalReportService medicalReportService;
    ...
    public ResponseEntity<?> getPatientReports(@PathVariable Long patientId) {
        try {
            List<com.tabib24x7.model.MedicalReport> reports = medicalReportService.getReportsByPatient(patientId);
        ...
        try {
            ...
            if (profileData.containsKey("services")) {
                ...
                for (Map<String, Object> svc : services) {
                    com.tabib24x7.model.DoctorService service = new com.tabib24x7.model.DoctorService();
