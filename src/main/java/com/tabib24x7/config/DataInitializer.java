...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        createDoctorWithUser("Dr. Zainab Khan", "dr.zainab@tabib24x7.com", "doctor123", "+91 9906234567",
        ...
        createDoctorWithUser("Dr. Umar Farooq", "dr.umar@tabib24x7.com", "doctor123", "+91 9906345678",
    ...
    private void createSuperAdmin() {
        if (userRepository.findByEmail("admin@tabib24x7.com").isEmpty()) {
            // Create user
            User adminUser = new User();
            adminUser.setEmail("admin@tabib24x7.com");
            ...
            System.out.println("Email: admin@tabib24x7.com");
