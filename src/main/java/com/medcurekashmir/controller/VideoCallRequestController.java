...
import com.medcurekashmir.dto.SignalMessage;
...
import com.medcurekashmir.service.VideoCallRequestService;
import com.medcurekashmir.service.VideoCallRateService;
    ...
    public Map<String, Object> createVideoCallRequest(
        ...
        try {
            ...
            if (!walletService.hasSufficientBalance(wallet, minimumCharge)) {
                response.put("success", false);
                response.put("message", "Insufficient wallet balance. Please add at least ₹" + minimumCharge + " to your wallet.");
