...
class LocationManager {
    constructor() {
        ...
        this.radius = 10; // Default search radius in km
        this.init();
    }
    ...
    displayNearbyDoctors(doctors) {
        ...
        container.innerHTML = doctors.map(doctor => `
            <div class="doctor-card location-doctor" data-distance="${doctor.distance}">
    ...
    changeRadius() {
        const newRadius = prompt('Enter search radius in km (5-50):', this.radius);
